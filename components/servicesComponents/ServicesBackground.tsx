...
const ServicesBackground = ({
  ...
  useEffect(() => {
    ...
    console.warn("Max WebGL contexts reached, skipping ServicesBackground render");
  }, []);
  ...
  useEffect(() => {
    ...
    const handleContextLost = (event: Event) => {
      ...
      console.warn("WebGL context lost in ServicesBackground");
  ...
  }, [color, amplitude, distance, enableMouseInteraction, canRender]);
  ...
  if (!canRender) {
    return (
      <div
        ...
        style={{
          background: `radial-gradient(circle at center, rgba(${color[0] * 255}, ${color[1] * 255}, ${color[2] * 255}, 0.1) 0%, transparent 70%)`,
        }}
        {...rest}
      />
    );
